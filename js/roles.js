...
export const ROLES = {
  ...
  MECHA_GIAN: {
    ...
    camp: "WOLF",
    name: "メカジャイアン",
    description: "人狼。ジャイアンを倒すために作られたロボットだったが、意気投合。",
  ...
  SUNEO: {
    ...
    camp: "WOLF",
    name: "スネ夫",
    description: "村人。人狼側についており、裏で暗躍する。しかし人狼はそれを知ることはない。不憫。",
    priority: 90, // 能力ターンにやることはない
  ...
  DORAEMON: {
    ...
    camp: "VILLAGER",
    name: "ドラえもん",
    description: "村人。町の平和を守るため、することレンズでその人を見通す。",
  ...
  SHIZUKA: {
    ...
    camp: "VILLAGER",
    name: "しずか",
    description: "村人。町の平和を守るため、人狼に襲撃されたけが人を治す。",
    priority: 20, // 襲撃より先
    action: (actor, target) => {
  ...
  DORAMI: {
    ...
    camp: "VILLAGER",
    name: "ドラミ",
    description: "村人。町の平和を守るため、テレバしいで今までに気絶してしまった人の役職を知る。",
    priority: 60, // 占いと同じタイミング
    action: (actor, target) => {
      // ゴルゴンの首による気絶者は「不明」
      if (target.isStone) return { success: true, message: "不明" };
      return { success: true, message: target.realRole }; // 正確な役職が判明
    }
  },
  ...
  JAIKO: {
    ...
    camp: "VILLAGER",
    name: "ジャイ子",
    description: "村人。能力ターンにする行動はない。",
    priority: 90, // パッシブ能力なので行動順は最後
    action: () => { return { success: true, message: "行動なし" }; }
  },
  ...
  SEWASHI: {
    ...
    camp: "VILLAGER",
    name: "セワシ",
    description: "村人。町の平和を守るため、前の日にどんな行動をしていたのかタイムマシンで確認する。",
    ...
    action: (actor, target, gameState) => {
      ...
      if (target.isBlocked) {
        return { success: true, message: "×" }; // 先生の妨害を受けた場合
      }
  ...
  SENSEI: {
    ...
    camp: "VILLAGER",
    name: "先生",
    description: "村人。家庭訪問のため、人狼村人問わず対象者をその日の行動を足止めする。",
    priority: 10, // 最速発動 
    action: (actor, target) => {
  ...
  NOBITA: {
    ...
    camp: "VILLAGER",
    name: "のび太",
    description: "村人。自分が何かしらの役職を持っていると思いこんでいるが、能力の使用結果はでたらめ。",
    priority: 99, 
    action: (actor, target) => {
      // 実際の効果はなし。結果表示UI側でランダムな値を返す処理を行う
  ...
  DEKISUGI: {
    ...
    camp: "THIRD",
    name: "出木杉",
    description: "第三者。対象者の役職を予想して推理することができる。",
    priority: 40, // 襲撃フェーズの後
    action: (actor, target, gameState, extraParams) => {
      // extraParams.guessedRole: プレイヤーが推理した役職ID
      if (!extraParams || !extraParams.guessedRole) return { success: true, message: "推理しない" };
  ...
  GORGON: {
    ...
    camp: "THIRD",
    name: "ゴルゴンの首",
    description: "第三者。自由に動き、人一人を石化する。",
  ...
  COPY_ROBOT: {
    ...
    camp: "THIRD",
    name: "コピーロボット",
    description: "第三者。一度だけ対象者を気絶させ、役職をコピーする。",
    priority: 25, // 襲撃より先
    action: (actor, target) => {
      if (!target.isProtected) {
        target.isAlive = false;
  ...
  HARUO: {
    ...
    camp: "THIRD",
    name: "はる夫",
    description: "第三者。誰か一人を「安雄」に登録する。",
    priority: 50, 
    action: (actor, target) => {
      actor.haruoTargetId = target.id; // ターゲットを安雄として登録
  ...
  KAMINARI: {
    ...
    camp: "THIRD",
    name: "神成さん",
    description: "第三者。ランダムで生存している自分以外のプレイヤーを1人ずつ叱りつけて気絶させる。",
    priority: 0, // 最速のオート能力
